...
package dev.minios.pdaiv1.presentation.modal
...
import dev.minios.pdaiv1.core.common.extensions.openAppSettings
...
import dev.minios.pdaiv1.presentation.core.ImageToImageIntent
import dev.minios.pdaiv1.presentation.modal.crop.CropImageModal
import dev.minios.pdaiv1.presentation.modal.download.DownloadDialog
import dev.minios.pdaiv1.presentation.modal.embedding.EmbeddingScreen
import dev.minios.pdaiv1.presentation.modal.extras.ExtrasScreen
import dev.minios.pdaiv1.presentation.modal.grid.GridBottomSheet
import dev.minios.pdaiv1.presentation.modal.history.InputHistoryScreen
import dev.minios.pdaiv1.presentation.modal.language.LanguageBottomSheet
import dev.minios.pdaiv1.presentation.modal.ldscheduler.LDSchedulerBottomSheet
import dev.minios.pdaiv1.presentation.modal.tag.EditTagDialog
import dev.minios.pdaiv1.presentation.model.Modal
import dev.minios.pdaiv1.presentation.screen.debug.DebugMenuIntent
import dev.minios.pdaiv1.presentation.screen.falai.FalAiGenerationIntent
import dev.minios.pdaiv1.presentation.screen.gallery.detail.GalleryDetailIntent
import dev.minios.pdaiv1.presentation.screen.gallery.list.GalleryIntent
import dev.minios.pdaiv1.presentation.screen.inpaint.InPaintIntent
import dev.minios.pdaiv1.presentation.screen.report.ReportIntent
import dev.minios.pdaiv1.presentation.screen.settings.SettingsIntent
import dev.minios.pdaiv1.presentation.screen.setup.ServerSetupIntent
import dev.minios.pdaiv1.presentation.widget.dialog.DecisionInteractiveDialog
import dev.minios.pdaiv1.presentation.widget.dialog.ErrorDialog
import dev.minios.pdaiv1.presentation.widget.dialog.GenerationImageBatchResultModal
import dev.minios.pdaiv1.presentation.widget.dialog.GenerationImageResultDialog
import dev.minios.pdaiv1.presentation.widget.dialog.InfoDialog
import dev.minios.pdaiv1.presentation.widget.dialog.ProgressDialog
import dev.minios.pdaiv1.presentation.widget.dialog.ProgressDialogCancelButton
