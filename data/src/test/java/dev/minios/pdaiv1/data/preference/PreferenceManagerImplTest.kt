...
import dev.minios.pdaiv1.data.preference.PreferenceManagerImpl.Companion.KEY_AI_AUTO_SAVE
import dev.minios.pdaiv1.data.preference.PreferenceManagerImpl.Companion.KEY_DEMO_MODE
import dev.minios.pdaiv1.data.preference.PreferenceManagerImpl.Companion.KEY_DESIGN_COLOR_TOKEN
import dev.minios.pdaiv1.data.preference.PreferenceManagerImpl.Companion.KEY_DESIGN_DARK_THEME
import dev.minios.pdaiv1.data.preference.PreferenceManagerImpl.Companion.KEY_DESIGN_DARK_TOKEN
import dev.minios.pdaiv1.data.preference.PreferenceManagerImpl.Companion.KEY_DESIGN_DYNAMIC_COLORS
import dev.minios.pdaiv1.data.preference.PreferenceManagerImpl.Companion.KEY_DESIGN_SYSTEM_DARK_THEME
import dev.minios.pdaiv1.data.preference.PreferenceManagerImpl.Companion.KEY_FORCE_SETUP_AFTER_UPDATE
import dev.minios.pdaiv1.data.preference.PreferenceManagerImpl.Companion.KEY_FORM_ALWAYS_SHOW_ADVANCED_OPTIONS
import dev.minios.pdaiv1.data.preference.PreferenceManagerImpl.Companion.KEY_FORM_PROMPT_TAGGED_INPUT
import dev.minios.pdaiv1.data.preference.PreferenceManagerImpl.Companion.KEY_HORDE_API_KEY
import dev.minios.pdaiv1.data.preference.PreferenceManagerImpl.Companion.KEY_HUGGING_FACE_API_KEY
import dev.minios.pdaiv1.data.preference.PreferenceManagerImpl.Companion.KEY_HUGGING_FACE_MODEL_KEY
import dev.minios.pdaiv1.data.preference.PreferenceManagerImpl.Companion.KEY_LOCAL_MODEL_ID
import dev.minios.pdaiv1.data.preference.PreferenceManagerImpl.Companion.KEY_LOCAL_NN_API
import dev.minios.pdaiv1.data.preference.PreferenceManagerImpl.Companion.KEY_MONITOR_CONNECTIVITY
import dev.minios.pdaiv1.data.preference.PreferenceManagerImpl.Companion.KEY_OPEN_AI_API_KEY
import dev.minios.pdaiv1.data.preference.PreferenceManagerImpl.Companion.KEY_SAVE_TO_MEDIA_STORE
import dev.minios.pdaiv1.data.preference.PreferenceManagerImpl.Companion.KEY_SD_MODEL
import dev.minios.pdaiv1.data.preference.PreferenceManagerImpl.Companion.KEY_SERVER_SOURCE
import dev.minios.pdaiv1.data.preference.PreferenceManagerImpl.Companion.KEY_SERVER_URL
import dev.minios.pdaiv1.data.preference.PreferenceManagerImpl.Companion.KEY_STABILITY_AI_API_KEY
import dev.minios.pdaiv1.data.preference.PreferenceManagerImpl.Companion.KEY_STABILITY_AI_ENGINE_ID_KEY
