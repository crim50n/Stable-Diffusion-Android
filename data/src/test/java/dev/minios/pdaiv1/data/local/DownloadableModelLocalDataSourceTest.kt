...
import dev.minios.pdaiv1.data.mocks.mockLocalAiModels
import dev.minios.pdaiv1.data.mocks.mockLocalModelEntities
import dev.minios.pdaiv1.data.mocks.mockLocalModelEntity
...
class DownloadableModelLocalDataSourceTest {
    ...
    @Test
    fun `given attempt to get model by id, dao throws exception, expected error`() {
        every {
            stubDao.queryById(any())
        } returns Single.error(stubException)
